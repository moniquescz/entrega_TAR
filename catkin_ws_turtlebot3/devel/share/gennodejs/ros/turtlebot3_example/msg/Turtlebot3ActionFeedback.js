...
class Turtlebot3ActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Turtlebot3Feedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Turtlebot3ActionFeedback(null);
    ...
    data.feedback = Turtlebot3Feedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += Turtlebot3Feedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Turtlebot3ActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = Turtlebot3Feedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new Turtlebot3Feedback()
    }
...
module.exports = Turtlebot3ActionFeedback;
