...
class Turtlebot3ActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Turtlebot3Result.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += Turtlebot3Result.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Turtlebot3ActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = Turtlebot3Result.Resolve(msg.result)
    }
    else {
      resolved.result = new Turtlebot3Result()
    }
...
module.exports = Turtlebot3ActionResult;
