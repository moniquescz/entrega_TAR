...
"""autogenerated by genpy from turtlebot3_example/Turtlebot3ActionGoal.msg. Do not edit."""
import codecs
import sys
...
class Turtlebot3ActionGoal(genpy.Message):
  _md5sum = "629663823fea578d64180162f10bec87"
  _type = "turtlebot3_example/Turtlebot3ActionGoal"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','turtlebot3_example/Turtlebot3Goal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Turtlebot3ActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = turtlebot3_example.msg.Turtlebot3Goal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = turtlebot3_example.msg.Turtlebot3Goal()
