...
echo_and_run cd "/workspace/catkin_ws/src/Turtlebot_on_noetic/kobuki/kobuki_testsuite"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/workspace/catkin_ws/src/Turtlebot_on_noetic/kobuki/kobuki_testsuite/setup.py" \
     \
    build --build-base "/workspace/catkin_ws/build/Turtlebot_on_noetic/kobuki/kobuki_testsuite" \
    install \
    --root="${DESTDIR-/}" \
